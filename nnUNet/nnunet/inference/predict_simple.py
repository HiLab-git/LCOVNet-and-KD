...
def main():
    ...
    # parser.add_argument('-trainer', '--trainer_file', required=True)
    # model_folder_name
    # parser.add_argument('-mfn', '--model_folder_name', required=True)
    
    
    args = parser.parse_args()
    input_folder = "/home/data/xw/zhaoqianfei/LCOVNet/LXD/dataset/nnUNet_raw_data_base/nnUNet_raw_data/Task013/imagesTs"
    output_folder = "/home/data/xw/zhaoqianfei/LCOVNet/LXD/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task013/nnUNetTrainerV2__SRv1/fold_0/MSKD_CAKD"
    model_folder_name = "/home/data/xw/zhaoqianfei/LCOVNet/LXD/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task013/nnUNetTrainerV2_MSKD_CAKD__SRv1"
    task_name = "13"
    folds = [0]
    model = "3d_fullres"
    ...
    # model_folder_name = "/home/data/xw/zhaoqianfei/LCOVNet/LXD/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task013/nnUNetTrainerV2__MSKD__SRv1"
