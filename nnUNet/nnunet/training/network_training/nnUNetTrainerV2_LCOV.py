...
class nnUNetTrainerV2_LCOV(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.mode = "nnUNetTrainerV2_LCOV"
    ...
    def initialize_network(self):
        ...
        from nnunet.network_architecture.LCOVNet import LCOV_Net, Teacher_LCOV_Net
        n_class = self.num_classes
        self.network = LCOV_Net(C_in=32, n_classes=n_class, m=1)
    ...
    def initialize_teacher_network(self):
        ...
        采用知识蒸馏的方法
        """
        # from nnunet.network_architecture.LCOVNet_KD_LXD_A import LCOVNet_KD_LXD_A_Teacher
        # self.teacher_network = LCOVNet_KD_LXD_A_Teacher()
        from nnunet.network_architecture.Unet_teacher import UNet
        self.teacher_network = UNet()
        self.teacher_network.cuda()
        teacher_checkpoint = '/home/data/xw/zhaoqianfei/LCOVNet/LXD/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task001/nnUNetTrainerV2_UNet_teacher__My_Own_UNet/all/model_best.model'
        # teacher_model = nn.DataParallel(self.teacher_network).cuda()
        ...
        for k, value in saved_teacher_checkpoint['state_dict'].items():
            ...
            if key not in curr_state_dict_keys and key.startswith('module.'):
                key = key[7:]
            # if key.startswith('segout1') or key.startswith('segout2'):
            #     continue
