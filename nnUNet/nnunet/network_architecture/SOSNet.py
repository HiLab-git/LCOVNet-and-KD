...
class SOSNet(SegmentationNetwork):
    def __init__(self, C_in=32, n_classes=17, m=1, is_ds=True):
        ...
        self.SESE = UnetBlock_SE(self.ft_chns[0])

        self.conv3 = UnetBlock_Encode(self.ft_chns[0], self.ft_chns[0])
        # self.conv4 = UnetBlock_Encode(self.ft_chns[0], self.ft_chns[0])
